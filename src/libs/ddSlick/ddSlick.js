(function (e) {
    ...
    var c = {}, d = {
        ...
        b = '<style id="css-ddslick" type="text/css">' +
            ...
            '.dd-selected{height: 50px;; color: #FFFFFF; display: flex; align-items: center; :hidden; padding:5px; font-weight:normal;}' +
            ...
            '.dd-option-image, ' +
            '.dd-selected-image { width: 32px; height: 32px; border-radius: 50%; vertical-align:middle; float:left; margin-right:10px; max-width:64px;}' +
            '.dd-image-right { float:right; margin-right:15px; margin-left:5px;}.dd-container{ position:relative;}​ ' +
